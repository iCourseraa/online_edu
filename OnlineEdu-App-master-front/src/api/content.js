...
// 判断学员是否已经订阅课程
export function getIsfavoriteCourse(id) {
  return request({
    url: `${api_prefix}/get/course/isfavorite/${id}`,
    method: 'get'
  })
}
...
// 订阅列表
export function relList(id) {
  return request({
    url: `/api/rel-course-member/list/${id}`,
    method: 'get'
  })
}
// 加入学习列表
export function getIsStudy(id) {
  return request({
    url: `/api/rel-course-member/isbuy/${id}`,
    method: 'get'
  })
}

// 学习列表
export function listStudy(id) {
  return request({
    url: `/api/rel-course-member/listStudy/${id}`,
    method: 'get'
  })
}
// 提醒列表
export function listWarning(id) {
  return request({
    url: `/api/rel-course-member/listWarning/${id}`,
    method: 'get'
  })
}