<template>
  <el-dialog :visible.sync="loginFormVisible" top="25vh" width="400px" custom-class="login" :show-close="false"
    :close-on-click-modal="false" @closed="close">
    <el-tabs v-model="tabName" type="border-card" :stretch="true">
      <el-tab-pane label="登录" name="login">
        <el-form ref="loginForm" :model="loginForm">
          <el-form-item prop="username">
            <el-input v-model="loginForm.username" type="text" placeholder="请输入手机号" autocomplete="off"
      ...
      <el-tab-pane label="注册" name="register">
        <el-form ref="regForm" :model="regForm">
          <el-form-item prop="username">
            <el-input v-model="regForm.username" type="text" placeholder="请输入手机号" autocomplete="off"
              prefix-icon="el-icon-user" />
          </el-form-item>
          <el-form-item prop="password">
            <el-input v-model="regForm.password" type="password" placeholder="请输入密码" autocomplete="off"
              prefix-icon="el-icon-lock" />
          </el-form-item>
          <el-form-item prop="checkPassword">
            <el-input v-model="regForm.confirmPassword" type="password" placeholder="请确认密码" autocomplete="off"
              prefix-icon="el-icon-lock" />
          </el-form-item>
          <el-form-item>
