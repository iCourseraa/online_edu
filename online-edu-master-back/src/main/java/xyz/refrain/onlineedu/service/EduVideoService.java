...
import xyz.refrain.onlineedu.mapper.EduVideoMapper_new;
...
public class EduVideoService {
	...
	@Resource
	private EduVideoMapper_new eduVideoMapper_new;
	...
	public List<EduVideoEntity_new> getListAll(HttpServletRequest request) {
//		LambdaQueryWrapper<EduVideoEntity> queryWrapper = new LambdaQueryWrapper<>();
        ...
        assert teacher != null;
        List<EduVideoEntity_new> eduVideoEntities_new = eduVideoMapper_new.selectListWithCourse(teacher.getId());
//		List<EduVideoEntity> eduVideoEntities = eduVideoMapper.selectList(queryWrapper);
		log.info(eduVideoEntities_new.toString());
		return eduVideoEntities_new;
	}
}
