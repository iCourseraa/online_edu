...
var TextService = /*#__PURE__*/function () {
  ...
  return _createClass(TextService, [{
    ...
    value: function wordWrap(text, parsedStyle, offscreenCanvas) {
      ...
      function appendEllipsis(lineIndex) {
        ...
        var currentLineLength = lines[lineIndex] ? lines[lineIndex].length : 0;
        var lastLineWidth = 0;
        var lastLineIndex = currentLineLength;
        for (var i = 0; i < currentLineLength; i++) {
          var width = calcWidth(lines[lineIndex][i]);
        ...
        lines[lineIndex] = (lines[lineIndex] || '').slice(0, lastLineIndex) + ellipsis;
      }
